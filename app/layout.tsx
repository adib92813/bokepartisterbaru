...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepartisterbaru.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://bokepartisterbaru.pages.dev/favicon.ico",
        "url": "https://bokepartisterbaru.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepartisterbaru.pages.dev"
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepartisterbaru.pages.dev/?q={search_term}", 
